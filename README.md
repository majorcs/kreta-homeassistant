...
- a tanuló profiljában (a `Timetable JSON` szenzor attribútumaiban) megjelenik az oktatási azonosító, az osztály neve és az osztályfőnök neve is, ha az e-Kréta visszaadja ezeket
